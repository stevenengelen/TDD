...
class SendLoginEmailViewTest(TestCase) :
    ...
    # this decorator tells us which function to mock for the duration of this test
    @patch('accounts.views.send_mail')
    # the mocked object gets passed as argument, we can choose whatever name
    ...
    def test_adds_success_message(self) :
        # follow = True tells the test client to get the page with errors using the framework
        response = self.client.post('/accounts/send_login_email', data = { 'email' : 'edith@example.com' }, follow = True)

        # we need to make a list out of the response
